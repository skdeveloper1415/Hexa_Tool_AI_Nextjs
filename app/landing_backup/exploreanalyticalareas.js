        ...
        <Slider {...settings}>
          <div className="boxshadow2 bg-white py-[30px] 3xl:py-[1.563vw] rounded-[4px] 3xl:rounded-[0.208vw]">
            <div className="flex flex-col items-center justify-center space-y-[34px] xl:space-y-[42px] 3xl:space-y-[2.188vw]">
              <div className="col icon">
                <Image
                  src={"/images/landing/genAi_icon.svg"}
                  width={"118"}
                  height={"122"}
                  alt="icon"
                />
              </div>
              <div className="text-[#344054] text-[20px] lg:text-[28px] 3xl:text-[1.458vw]">
              Brix AI Apps
              </div>
              <div className="col">
                <Link
                  href={"/"}
                  className="inline-flex items-center bg-[#1570EF] rounded-[8px] 3xl:rounded-[0.417vw] px-[18px] 3xl:px-[0.938vw] py-[10px] 3xl:py-[0.521vw] text-white text-[16px] 3xl:text-[0.833vw]"
                >
                  <i className="hexatoolexport text-[18px] 3xl:text-[0.938vw] mr-[8px] 3xl:mr-[0.417vw]"></i>{" "}
                  Open
                </Link>
              </div>
            </div>
          ...
          <div className="boxshadow2 bg-white py-[30px] 3xl:py-[1.563vw] rounded-[4px] 3xl:rounded-[0.208vw]">
            <div className="flex flex-col items-center justify-center space-y-[34px] xl:space-y-[42px] 3xl:space-y-[2.188vw]">
              <div className="col icon">
                <Image
                  src={"/images/landing/roster_icon.svg"}
                  width={"123"}
                  height={"122"}
                  alt="icon"
                />
          ...
          <div className="boxshadow2 bg-white py-[30px] 3xl:py-[1.563vw] rounded-[4px] 3xl:rounded-[0.208vw]">
            <div className="flex flex-col items-center justify-center space-y-[34px] xl:space-y-[42px] 3xl:space-y-[2.188vw]">
              <div className="col icon">
                <Image
                  src={"/images/landing/manage_icon.svg"}
                  width={"123"}
                  height={"122"}
                  alt="icon"
                />
          ...
          <div className="boxshadow2 bg-white py-[30px] 3xl:py-[1.563vw] rounded-[4px] 3xl:rounded-[0.208vw]">
            <div className="flex flex-col items-center justify-center space-y-[34px] xl:space-y-[42px] 3xl:space-y-[2.188vw]">
              <div className="col icon">
                <Image
                  src={"/images/landing/dashboard_icon.svg"}
                  width={"123"}
                  height={"122"}
                  alt="icon"
                />
