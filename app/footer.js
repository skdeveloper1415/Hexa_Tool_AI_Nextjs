            ...
            <div className="col">
              <div className="flex items-center justify-center lg:justify-end gap-[15px] lg:gap-[30px] xl:gap-[70px] 3xl:gap-[3.646vw] mt-3 lg:mt-0">
                ...
                <div className="col">
                  <div
                    onClick={onClick}
                    className="inline-flex cursor-pointer	 items-center justify-center text-[#2F2326] bg-[#F0F3F8] w-[30px] lg:w-[50px] 3xl:w-[2.604vw] h-[30px] lg:h-[50px] 3xl:h-[2.604vw] text-[16px] 3xl:text-[0.833vw] text-[#2F2326]"
                  >
