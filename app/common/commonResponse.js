  ...
  return (
    <>
      <div className="bg-[#F2F4F7] xl:px-[0.833vw] px-[16px] xl:py-[0.417vw] py-[8px] rounded-lg flex justify-between items-center xl:mb-[1.25vw] mb-[18px]">
        ...
        <h3 className="3xl:text-[0.938vw] 2xl:text-[16px] text-[14px] text-[#1570EF] font-medium font-bold"><b>{props?.title}</b></h3>
        </div>
      ...
      <div className='customScroller h-[240px]'>
      ...
      <div className="flex justify-between items-center mt-[14px] xl:mt-[0.938vw]">
        <button className='flex 3xl:text-[0.833vw] 2xl:text-[16px] text-[14px] text-[#1570EF] font-medium border border-[#1570EF] rounded-lg xl:px-[1.04vw] px-[16px] xl:py-[0.573vw] py-[11px] justify-center items-center' onClick={handleSpeakerText}>
      ...
      </div>
      {
        ...
        <Note/>
      <div className="mt-[30px] xl:mt-[1.552vw] flex gap-[11px]">
        ...
        <button className='flex 3xl:text-[0.833vw] 2xl:text-[16px] text-[14px] text-[#fff] font-medium border border-[#1570EF] bg-[#1570EF] rounded-lg xl:px-[1.04vw] px-[16px] xl:py-[0.573vw] py-[11px] justify-center ml-[8px] items-center align-right'
