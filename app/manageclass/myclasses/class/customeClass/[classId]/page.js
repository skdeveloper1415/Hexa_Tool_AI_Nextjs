        ...
        <Layout>
            <div className='mx-auto 3xl:px-[16.771vw] 2xl:px-[150px] xl:px-[100px] px-[20px]'>
                ...
                <div className='mt-[36px] xl:mt-[34px] 3xl:mt-[1.875vw]'>
                    ...
                    <div>
                        {activeTab === 1 && <>
                            <Home classIdValue={classIdValue} setShowBack={setShowBack}/>
                        </>}
                        {activeTab === 2 && <>
                            <Post setShowBack={setShowBack} classIdValue={classIdValue}/>
                        </>}
                        {activeTab === 3 && <>
                            <ClassWork setShowBack={setShowBack} setActiveTab={setActiveTab} classIdValue={classIdValue}/>
                        </>}
                        {activeTab === 4 && <>
                            <People classIdValue={classIdValue} setShowBack={setShowBack} />
                        </>}
                        {activeTab === 5 && <>
                            <Grades setShowBack={setShowBack}/>
                        </>}
                    </div>
                </div>
            </div>
