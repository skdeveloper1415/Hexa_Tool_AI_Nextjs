  ...
  return (
    <>
      <div className="bg-white rounded-[4px] 3xl:rounded-[0.208vw] boxshadow1 mt-[30px] xl:mt-[50px] 3xl:mt-[2.604vw]">
        <div className="bg-[#1B55AF] px-[15px] lg:px-[24px] xl:px-[36px] 3xl:px-[1.875vw] py-[15px] lg:py-[20px] xl:py-[26px] 3xl:py-[1.354vw]">
          <div className="block lg:flex items-center lg:justify-between text-center lg:text-start">
            <div
              className={`${myRoboto_Slab.className} text-white text-[24px] xl:text-[26px] 2xl:text-[30px] 3xl:text-[2.188vw] font-normal`}
            >
              Quick Facts of Brix AI
            </div>
            <div className="col mt-2 lg:mt-0">
              <Link
                href={""}
                className="inline-flex border border-[#DAE5DD] rounded-[6px] 3xl:rounded-[0.313vw] text-[16px] 3xl:text-[0.938vw] px-[18px] 3xl:px-[0.938vw] py-[12px] 3xl:py-[0.625vw] text-white"
        ...
        <div className="py-[15px] lg:py-[24px] xl:py-[48px] 3xl:py-[2.5vw] px-[15px] lg:px-[25px] 3xl:px-[1.302vw]">
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-[12px] 3xl:gap-[0.625vw]">
            <div className="border border-[#DAE5DD] bg-white p-[15px] lg:p-[20px] 3xl:p-[1.042vw] rounded-[4px] 3xl:rounded-[0.208vw]">
              <div className="text-[#4B586E] text-[18px] 3xl:text-[1.25vw] h-[55px]">
              Classrooms Created
              </div>
              <div className="bg-[#DAE5DD] w-full h-[1px] 3xl:h-[0.052vw] mt-[20px] xl:mt-[20px] 3xl:mt-[1.042vw] mb-[12px] 3xl:mb-[0.625vw]"></div>
              <div className="flex items-center justify-between gap-[16px] 3xl:gap-[0.833vw]">
                <div className="text-[#4B586E] text-[20px] lg:text-[20px] xl:text-[20px] 3xl:text-[1.042vw] font-medium leading-none">
                  156 Classes
                </div>
                <div>
            ...
            <div className="border border-[#DAE5DD] bg-white p-[15px] lg:p-[20px] 3xl:p-[1.042vw] rounded-[4px] 3xl:rounded-[0.208vw]">
              <div className="text-[#4B586E] text-[16px] 3xl:text-[1.25vw] h-[55px]">
              Assignments/Quizzes per Instructor
              </div>
              <div className="bg-[#DAE5DD] w-full h-[1px] 3xl:h-[0.052vw] mt-[20px] xl:mt-[20px] 3xl:mt-[1.042vw] mb-[12px] 3xl:mb-[0.625vw]"></div>
              <div className="flex items-center justify-between gap-[16px] 3xl:gap-[0.833vw]">
              <div className="text-[#4B586E] text-[20px] lg:text-[20px] xl:text-[20px] 3xl:text-[1.042vw] font-medium leading-none">
                5 Per Instructor Per Week
                </div>
                <div>
                  <div className="text-[#4B586E] text-[12px] 3xl:text-[0.625vw]">
                    Last Year
              ...
              <div className="bg-[#DAE5DD] w-full h-[1px] 3xl:h-[0.052vw] mt-[20px] xl:mt-[20px] 3xl:mt-[1.042vw] mb-[12px] 3xl:mb-[0.625vw]"></div>
                <div className="grid grid-cols-3">
                  <div className="col">
                    ...
                    <div className="text-[#4B586E] text-[22px] xl:text-[26px] 3xl:text-[1.875vw]  leading-none">32%</div>
                  </div>
                  <div className="col">
                    ...
                    <div className="text-[#4B586E] text-[22px] xl:text-[26px] 3xl:text-[1.875vw] leading-none">54%</div>
                  </div>
                  <div className="col">
                    ...
                    <div className="text-[#4B586E] text-[22px] xl:text-[26px] 3xl:text-[1.875vw]  leading-none">14%</div>
                  </div>
                </div>
            </div>
            <div className="border border-[#DAE5DD] bg-white p-[15px] lg:p-[20px] 3xl:p-[1.042vw] rounded-[4px] 3xl:rounded-[0.208vw]">
