...
import { generateProfessionalEmail } from "../../app/actions/professionalEmailApi";
...
const ProfessionalEmail = ({ visible, onHide,setInstruction }) => {
            ...
            <div className="flex justify-between items-center gap-1">
              <div>
                ...
                <p className="3xl:text-[0.625vw] text-[12px] text-[#344054] xl:mb-[1.25vw] mb-[18px]">
                  Generate a Professional e-mail communication to colleagues
